...
void Temperature::task() {
  ...
  //TERN_(FEEDRATE_POT_SENSOR, feedpot.fpupdate_volumetric());
...
void Temperature::updateTemperaturesFromRawValues() {
  ...
  //TERN_(FEEDRATE_POT_SENSOR, feedpot.fpupdate_measured_mm());
...
void Temperature::init() {
  ...
  TERN_(FEEDRATE_POT_SENSOR,    hal.adc_enable(FEEDPOT_PIN));
...
void Temperature::readings_ready() {
  ...
  //TERN_(FEEDRATE_POT_SENSOR, feedpot.fpreading_ready());
