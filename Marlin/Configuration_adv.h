/**
 * Marlin 3D Printer Firmware MARLIN AUTOSTART
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 20*60, 20*60, 4*60} // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define G0_FEEDRATE MAXFEEDRATE  // (mm/min)
#ifdef G0_FEEDRATE
...
#define CUSTOM_USER_BUTTONS
  ...
  #define BUTTON1_PIN 40
    ...
    #define BUTTON1_DESC          "SD pause"  // Optional string to set the LCD status
  #endif
...
#define JOYSTICK
  ...
  #define JOY_X_LIMITS { 0, 8405-100, 8405+100, 16178 } // min, deadzone start, deadzone end, max
  #define JOY_Y_LIMITS { 0, 8516-100, 8516+100, 16113 }
